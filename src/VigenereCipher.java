 ...
 * Vigenere Cipher uses the Vigenere cipher to encrypt and decrypt a given
 * string by the user.
 */
public class VigenereCipher {
  ...
  // preconditions: takes in a print writer, a string that needs to be encoded, and the codeWord to
  // encode string
  // postconditions: prints a string with encoded phrase
  // encrypt encodes and prints a phrase based on a keyword inputed by the user by using the
  // Vigenere Cipher
  static void encrypt(PrintWriter pen, String arg, String codeWord) {
    ...
    do {
      ...
      int result = (currentBase + currentCodeWordBase) % alphaLength;
  ...
  // preconditions: takes in a print writer, a string that needs to be decoded, and the codeWord to
  // decode string
  // postconditions: prints a string with decoded phrase
  // decrypt decodes and prints a phrase based on a keyword inputed by the user by using the
  // Vigenere Cipher
